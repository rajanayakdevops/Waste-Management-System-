const userLocation = [22.292130, 73.363210];
const map = L.map('map', {
...
{ lat: 22.294765, lng: 73.364646, name: 'Eco-Friendly RecyclingHub' },
{ lat: 22.294192, lng: 73.362047, name: 'Nature Bounty CompostingFacility' },
{ lat: 22.293809, lng: 73.383052, name: 'Recycling Center 2 ' },{ lat: 22.285980, lng: 73.365361, name: 'GreenEarth CompostingStation' },{ lat: 22.288008, lng: 73.347635, name: 'Waste Warriors DisposalCenter' },
...
if (nearestFacility) {
const line = L.polyline([userLocation, nearestFacility], {
color: 'red' }).addTo(map);
map.fitBounds(line.getBounds()); // Adjust map view to fit the
line
const midPoint = [
...
html: `<div style="color: blue; font-weight:
bold;">Shortest Distance: ${Math.round(shortestDistance)} m</div>`,
iconSize: [150, 40],
iconAnchor: [75, 20]
});
